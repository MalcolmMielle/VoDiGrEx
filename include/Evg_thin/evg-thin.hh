...
inline evg_thin::evg_thin(const grid_type& curr_grid,
...
**/
inline skeleton_type evg_thin::generate_skeleton() {
...
inline bool evg_thin::on_grid(int x, int y) {
...
**/
inline void evg_thin::calculate_distances() {
...
**/
inline void evg_thin::find_skel() {
...
**/
inline void evg_thin::initialize() {  
...
inline evg_thin::State evg_thin::step(gridtype& grid, 
...
/**
   ...
   location.
**/
inline void evg_thin::find_skel_edge() {
...
**/
inline void evg_thin::build_skel() {
...
**/
inline void evg_thin::crawl_grid() {
...
**/
inline void evg_thin::remove_branch(int index, int child_index) {
  if (prune) 
    if (index >=0) {
...
/**
   ...
   exit.
**/
inline bool evg_thin::is_exit(const node& curr_node) {
 ...
 **/
inline vector<node> evg_thin::find_neighbors(int x, int y) {
 ...
 **/
inline void evg_thin::remove_final_spur() {
  if (prune)
    if (!_tmp_skel.empty())
...
/**
   ...
   need to be removed as well.
**/
inline void evg_thin::remove_branch2(int index) {
 ...
 **/
inline void evg_thin::best_to_depth_first() {
  if (!_tmp_skel.empty())
 ...
 **/
inline void evg_thin::best_to_depth_first_helper(int myindex, int parent_index){
